...
struct SettingsView: View {
    ...
    @State private var sharedPlanManager = SharedPlanManager()
    ...
    var body: some View {
        ...
        .task {
            identityStatus = await sharedPlanManager.identityStatus()
            cloudKitIdentity = await sharedPlanManager.resolvedCloudKitIdentity()
        }
    }
